/*
 * MembraneKevlarInit.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Feb 18 2018, 19:53 by COMSOL 5.3.1.201. */
public class MembraneKevlarInit {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model.modelPath("/home/ivan/\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0438");
    ...
    model.component("comp1").geom("geom1").feature("ps1").label("Membrane");
    ...
    model.component("comp1").geom("geom1").feature("pc1").label("Impact");
    ...
    model.component("comp1").geom("geom1").feature("fin").label("Full geometry");
    ...
    model.component("comp1").physics("shell").feature("vel1").selection().set(new int[]{2});
    ...
    model.component("comp1").view("view1").label("View");
    ...
    model.component("comp1").coordSystem("sys1").label("Boundaries");
    model.component("comp1").coordSystem("shellsys").label("Local system");
    ...
    model.component("comp1").physics("shell").feature("emm1").label("Linear elastic material");
    model.component("comp1").physics("shell").feature("free1").label("Free boundaries");
    model.component("comp1").physics("shell").feature("init1").label("Initial values");
    ...
    model.component("comp1").physics("shell").feature("vel1").label("Impact velocity");
    ...
    model.component("comp1").mesh("mesh1").feature("fq1").label("Free Quad");
    ...
    model.component("comp1").label("Main Component");
    model.label("membrane_kevlar.mph");
